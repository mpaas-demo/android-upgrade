package com.mpaas.demo.upgrade;
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (result == UpgradeConstants.HAS_NEW_VERSION) {
                                    Toast.makeText(UpgradeActivity.this, "有新版", Toast.LENGTH_SHORT).show();
                                } else if (result == UpgradeConstants.HAS_NO_NEW_VERSION) {
                                    Toast.makeText(UpgradeActivity.this, "当前已是新版", Toast.LENGTH_SHORT).show();
                                } else if (result == UpgradeConstants.HAS_SOME_ERROR) {
                                    Toast.makeText(UpgradeActivity.this, "检测新版本发生错误", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (null == res) {
                                    Toast.makeText(UpgradeActivity.this, "异常，获取升级结果为空", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(UpgradeActivity.this,
                                            "升级信息:" + res.guideMemo
                                                    + "\n升级模式：" + res.resultStatus
                                                    + "\n最新版本：" + res.newestVersion
                                                    + "\n下载地址：" + res.downloadURL, Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
